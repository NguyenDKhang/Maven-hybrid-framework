...
public class Level_20_Fake_Data_III extends BaseTest{
	...
	public void beforeClass(String browserName) {
		...
		existingEmail   = dataHelper.getEmailAddress();
...
//		year 			= userData.getYear();
	...
	@Test
	public void TC_01_Register(Method mothod) {
...
//		log.info("Register-Step 01: Navigate to register page");
		...
		ExtentTestManagerV5.startTest(mothod.getName(), "Run");
		ExtentTestManagerV5.getTest().log(Status.INFO, "Step 01");
...
//		log.info("Register-Step 07: Click register button");
		...
		homePage = registerPage.clickContine(driver);
	}
