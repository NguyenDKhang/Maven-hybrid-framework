...
public class Level_21_Multiple_Environment_Owner extends BaseTest{
	...
	public void beforeClass(String browserName, String environment) {
		...
		// Dùng để run bằng commentline
//		String environmentName = System.getProperty("environment");
		
		// Dùng trong file dev.properties
		ConfigFactory.setProperty("env",environment);
		
		environ = ConfigFactory.create(Environment.class);
		System.out.println(environ.appUrl());
		System.out.println(environ.appUser());
		System.out.println(environ.appPass());
		System.out.println(environ.dbHost());
		System.out.println(environ.dbPost());
		
		driver = getBrowserDriver(browserName, environ.appUrl());
		// Initial (Khởi tạo)
